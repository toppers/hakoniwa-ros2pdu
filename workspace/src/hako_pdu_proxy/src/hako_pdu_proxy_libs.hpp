...
extern bool hako_pdu_proxy_rx_data(HakoPduChannelIdType pdu_channel, char* pdu_msg, int buflen);
extern bool hako_pdu_proxy_tx_data(HakoPduChannelIdType pdu_channel, char* pdu_msg, int buflen);
extern bool hako_pdu_proxy_tx_init(HakoPduChannelIdType pdu_channel, int buflen);
