 ...
 * TODO
 */
bool hako_pdu_proxy_rx_data(HakoPduChannelIdType pdu_channel, Hako_HakoCan &can_msg)
{
    if (hako_asset->is_pdu_created() == false) {
        return false;
    }
...
bool hako_pdu_proxy_tx_data(HakoPduChannelIdType pdu_channel, Hako_HakoCan &can_msg)
{
