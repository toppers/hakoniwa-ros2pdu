...
static inline int _pdu2ros_Ev3PduMotor(const char* heap_ptr, Hako_Ev3PduMotor &src, ev3_msgs::msg::Ev3PduMotor &dst)
{
    // primitive convert
...
static inline int hako_convert_pdu2ros_Ev3PduMotor(Hako_Ev3PduMotor &src, ev3_msgs::msg::Ev3PduMotor &dst)
{
    ...
    if (heap_ptr == nullptr) {
        ...
        return _pdu2ros_Ev3PduMotor((char*)heap_ptr, src, dst);
    }
}
