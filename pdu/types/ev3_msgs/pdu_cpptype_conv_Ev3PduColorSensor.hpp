...
public:
    ...
    bool pdu2cpp(char* top_ptr, HakoCpp_Ev3PduColorSensor& cppData)
    {
        ...
        int ret = hako_convert_pdu2cpp_Ev3PduColorSensor(*(Hako_Twist*)base_ptr, cppData);
        if (ret != 0) {
    ...
    int cpp2pdu(HakoCpp_Ev3PduColorSensor& cppData, char* pdu_buffer, int buffer_len)
    {
        ...
        int pdu_size = hako_convert_cpp2pdu_Ev3PduColorSensor(cppData, (Hako_Twist**)&base_ptr);
        if (pdu_size < 0) {
