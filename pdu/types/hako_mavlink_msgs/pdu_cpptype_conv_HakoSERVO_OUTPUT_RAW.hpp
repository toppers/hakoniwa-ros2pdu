#ifndef _PDU_CPPTYPE_CONV_HAKO_hako_mavlink_msgs_HakoSERVO_OUTPUT_RAW_HPP_
#define _PDU_CPPTYPE_CONV_HAKO_hako_mavlink_msgs_HakoSERVO_OUTPUT_RAW_HPP_
...
public:
    ...
    bool pdu2cpp(char* top_ptr, HakoCpp_HakoSERVO_OUTPUT_RAW& cppData)
    {
        ...
        int ret = hako_convert_pdu2cpp_HakoSERVO_OUTPUT_RAW(*(Hako_Twist*)base_ptr, cppData);
        if (ret != 0) {
    ...
    int cpp2pdu(HakoCpp_HakoSERVO_OUTPUT_RAW& cppData, char* pdu_buffer, int buffer_len)
    {
        ...
        int pdu_size = hako_convert_cpp2pdu_HakoSERVO_OUTPUT_RAW(cppData, (Hako_Twist**)&base_ptr);
        if (pdu_size < 0) {
...
#endif /* _PDU_CPPTYPE_CONV_HAKO_hako_mavlink_msgs_HakoSERVO_OUTPUT_RAW_HPP_ */
