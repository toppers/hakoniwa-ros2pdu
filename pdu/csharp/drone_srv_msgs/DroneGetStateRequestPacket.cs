...
{
    public class DroneGetStateRequestPacket
    {
        protected internal readonly IPdu _pdu;
        public IPdu GetPdu() { return _pdu; }

        public DroneGetStateRequestPacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private DroneGetStateRequest _body;
        public DroneGetStateRequest body
        {
            get
            {
                if (_body == null)
                {
                    _body = new DroneGetStateRequest(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
