...
{
    public class DroneLandResponsePacket
    {
        protected internal readonly IPdu _pdu;
        public IPdu GetPdu() { return _pdu; }

        public DroneLandResponsePacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private DroneLandResponse _body;
        public DroneLandResponse body
        {
            get
            {
                if (_body == null)
                {
                    _body = new DroneLandResponse(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
