...
{
    public class DroneTakeOffRequestPacket
    {
        protected internal readonly IPdu _pdu;
        public IPdu GetPdu() { return _pdu; }

        public DroneTakeOffRequestPacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private DroneTakeOffRequest _body;
        public DroneTakeOffRequest body
        {
            get
            {
                if (_body == null)
                {
                    _body = new DroneTakeOffRequest(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
