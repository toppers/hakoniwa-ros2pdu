...
{
    public class DroneSetReadyRequestPacket
    {
        protected internal readonly IPdu _pdu;
        public IPdu GetPdu() { return _pdu; }

        public DroneSetReadyRequestPacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private DroneSetReadyRequest _body;
        public DroneSetReadyRequest body
        {
            get
            {
                if (_body == null)
                {
                    _body = new DroneSetReadyRequest(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
