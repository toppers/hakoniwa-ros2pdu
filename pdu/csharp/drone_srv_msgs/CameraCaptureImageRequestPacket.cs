...
namespace hakoniwa.pdu.msgs.drone_srv_msgs
{
    public class CameraCaptureImageRequestPacket
    {
        ...
        public CameraCaptureImageRequestPacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private CameraCaptureImageRequest _body;
        public CameraCaptureImageRequest body
        {
            get
            {
                if (_body == null)
                {
                    _body = new CameraCaptureImageRequest(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
