...
{
    public class CameraSetTiltResponsePacket
    {
        protected internal readonly IPdu _pdu;
        public IPdu GetPdu() { return _pdu; }

        public CameraSetTiltResponsePacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private CameraSetTiltResponse _body;
        public CameraSetTiltResponse body
        {
            get
            {
                if (_body == null)
                {
                    _body = new CameraSetTiltResponse(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
