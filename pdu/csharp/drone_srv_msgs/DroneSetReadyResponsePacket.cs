...
{
    public class DroneSetReadyResponsePacket
    {
        protected internal readonly IPdu _pdu;
        public IPdu GetPdu() { return _pdu; }

        public DroneSetReadyResponsePacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private DroneSetReadyResponse _body;
        public DroneSetReadyResponse body
        {
            get
            {
                if (_body == null)
                {
                    _body = new DroneSetReadyResponse(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
