...
{
    public class LiDARScanResponsePacket
    {
        protected internal readonly IPdu _pdu;
        public IPdu GetPdu() { return _pdu; }

        public LiDARScanResponsePacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private LiDARScanResponse _body;
        public LiDARScanResponse body
        {
            get
            {
                if (_body == null)
                {
                    _body = new LiDARScanResponse(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
