...
{
    public class DroneLandRequestPacket
    {
        protected internal readonly IPdu _pdu;
        public IPdu GetPdu() { return _pdu; }

        public DroneLandRequestPacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private DroneLandRequest _body;
        public DroneLandRequest body
        {
            get
            {
                if (_body == null)
                {
                    _body = new DroneLandRequest(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
