 ...
 */
export class SystemControlResponsePacket {
...
/** @type { SystemControlResponse } */
    ...
    constructor() {
        ...
        this.body = new SystemControlResponse();
    }
     ...
     */
    static fromDict(d) {
        const obj = new SystemControlResponsePacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = SystemControlResponse;
            if (d.body) {
