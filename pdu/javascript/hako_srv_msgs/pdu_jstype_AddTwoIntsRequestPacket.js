import { AddTwoIntsRequest } from '../hako_srv_msgs/pdu_jstype_AddTwoIntsRequest.js';
 ...
 */
export class AddTwoIntsRequestPacket {
...
/** @type { AddTwoIntsRequest } */
    ...
    constructor() {
        ...
        this.body = new AddTwoIntsRequest();
    }
     ...
     */
    static fromDict(d) {
        const obj = new AddTwoIntsRequestPacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = AddTwoIntsRequest;
            if (d.body) {
