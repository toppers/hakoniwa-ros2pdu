import { RegisterClientRequest } from '../hako_srv_msgs/pdu_jstype_RegisterClientRequest.js';
 ...
 */
export class RegisterClientRequestPacket {
...
/** @type { RegisterClientRequest } */
    ...
    constructor() {
        ...
        this.body = new RegisterClientRequest();
    }
     ...
     */
    static fromDict(d) {
        const obj = new RegisterClientRequestPacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = RegisterClientRequest;
            if (d.body) {
