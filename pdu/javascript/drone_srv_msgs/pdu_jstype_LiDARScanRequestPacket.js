...
/**
 * ROS message: drone_srv_msgs/LiDARScanRequestPacket
 * Generated by hakoniwa-ros2pdu.
 */
export class LiDARScanRequestPacket {
...
/** @type { LiDARScanRequest } */
    ...
    constructor() {
        ...
        this.body = new LiDARScanRequest();
    }
     ...
     */
    static fromDict(d) {
        const obj = new LiDARScanRequestPacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = LiDARScanRequest;
            if (d.body) {
