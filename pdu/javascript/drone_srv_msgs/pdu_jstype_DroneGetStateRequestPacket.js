 ...
 */
export class DroneGetStateRequestPacket {
...
/** @type { DroneGetStateRequest } */
    ...
    constructor() {
        ...
        this.body = new DroneGetStateRequest();
    }
     ...
     */
    static fromDict(d) {
        const obj = new DroneGetStateRequestPacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = DroneGetStateRequest;
            if (d.body) {
