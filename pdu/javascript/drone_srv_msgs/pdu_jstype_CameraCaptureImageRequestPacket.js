 ...
 */
export class CameraCaptureImageRequestPacket {
...
/** @type { CameraCaptureImageRequest } */
    ...
    constructor() {
        ...
        this.body = new CameraCaptureImageRequest();
    }
     ...
     */
    static fromDict(d) {
        const obj = new CameraCaptureImageRequestPacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = CameraCaptureImageRequest;
            if (d.body) {
