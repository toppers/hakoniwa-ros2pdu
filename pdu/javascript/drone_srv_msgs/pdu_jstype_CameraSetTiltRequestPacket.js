 ...
 */
export class CameraSetTiltRequestPacket {
...
/** @type { CameraSetTiltRequest } */
    ...
    constructor() {
        ...
        this.body = new CameraSetTiltRequest();
    }
     ...
     */
    static fromDict(d) {
        const obj = new CameraSetTiltRequestPacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = CameraSetTiltRequest;
            if (d.body) {
