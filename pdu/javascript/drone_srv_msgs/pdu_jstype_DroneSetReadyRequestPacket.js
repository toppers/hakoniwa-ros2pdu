 ...
 */
export class DroneSetReadyRequestPacket {
...
/** @type { DroneSetReadyRequest } */
    ...
    constructor() {
        ...
        this.body = new DroneSetReadyRequest();
    }
     ...
     */
    static fromDict(d) {
        const obj = new DroneSetReadyRequestPacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = DroneSetReadyRequest;
            if (d.body) {
