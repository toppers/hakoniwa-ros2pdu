 ...
 */
export class DroneTakeOffResponsePacket {
...
/** @type { DroneTakeOffResponse } */
    ...
    constructor() {
        ...
        this.body = new DroneTakeOffResponse();
    }
     ...
     */
    static fromDict(d) {
        const obj = new DroneTakeOffResponsePacket();
        ...
        if (d.hasOwnProperty('body')) {
            const field_class = DroneTakeOffResponse;
            if (d.body) {
