...
def pdu_to_py_Point(binary_data: bytearray) -> Point:
    py_obj = Point()
...
def binary_read_recursive_Point(meta: binary_io.PduMetaData, binary_data: bytearray, py_obj: Point, base_off: int):
    # array_type: single 
    # data_type: primitive 
    # member_name: x 
    # type_name: float64 
...
def py_to_pdu_Point(py_obj: Point) -> bytearray:
    ...
    binary_write_recursive_Point(0, bw_container, base_allocator, py_obj)
...
def binary_write_recursive_Point(parent_off: int, bw_container: BinaryWriterContainer, allocator, py_obj: Point):
    # array_type: single 
    # data_type: primitive 
    # member_name: x 
    # type_name: float64 
...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_Point <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_Point(binary_data)
        ...
        py_obj = Point.from_json(json_str)
        
        binary_data = py_to_pdu_Point(py_obj)
