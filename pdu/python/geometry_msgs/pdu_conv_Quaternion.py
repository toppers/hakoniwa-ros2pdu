...
def pdu_to_py_Quaternion(binary_data: bytes) -> Quaternion:
    py_obj = Quaternion()
...
def binary_read_recursive_Quaternion(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: Quaternion, base_off: int):
    # array_type: single 
    # data_type: primitive 
    # member_name: x 
    # type_name: float64 
