...
def py_to_pdu_ShareObjectOwnerResponse(py_obj: ShareObjectOwnerResponse) -> bytearray:
...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_ShareObjectOwnerResponse <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_ShareObjectOwnerResponse(binary_data)
        ...
        py_obj = ShareObjectOwnerResponse.from_json(json_str)
        
        binary_data = py_to_pdu_ShareObjectOwnerResponse(py_obj)
