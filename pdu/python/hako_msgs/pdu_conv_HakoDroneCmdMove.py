...
def pdu_to_py_HakoDroneCmdMove(binary_data: bytes) -> HakoDroneCmdMove:
...
def binary_read_recursive_HakoDroneCmdMove(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: HakoDroneCmdMove, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: header 
