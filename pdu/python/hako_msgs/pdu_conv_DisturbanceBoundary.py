...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_DisturbanceBoundary <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_DisturbanceBoundary(binary_data)
        ...
        py_obj = DisturbanceBoundary.from_json(json_str)
        
        binary_data = py_to_pdu_DisturbanceBoundary(py_obj)
