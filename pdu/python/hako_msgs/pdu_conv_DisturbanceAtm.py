...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_DisturbanceAtm <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_DisturbanceAtm(binary_data)
        ...
        py_obj = DisturbanceAtm.from_json(json_str)
        
        binary_data = py_to_pdu_DisturbanceAtm(py_obj)
