...
def py_to_pdu_HakoCmdHeader(py_obj: HakoCmdHeader) -> bytearray:
...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_HakoCmdHeader <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_HakoCmdHeader(binary_data)
        ...
        py_obj = HakoCmdHeader.from_json(json_str)
        
        binary_data = py_to_pdu_HakoCmdHeader(py_obj)
