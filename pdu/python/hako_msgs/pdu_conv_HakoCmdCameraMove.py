...
def py_to_pdu_HakoCmdCameraMove(py_obj: HakoCmdCameraMove) -> bytearray:
...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_HakoCmdCameraMove <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_HakoCmdCameraMove(binary_data)
        ...
        py_obj = HakoCmdCameraMove.from_json(json_str)
        
        binary_data = py_to_pdu_HakoCmdCameraMove(py_obj)
