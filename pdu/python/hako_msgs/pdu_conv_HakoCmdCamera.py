...
def pdu_to_py_HakoCmdCamera(binary_data: bytes) -> HakoCmdCamera:
...
def binary_read_recursive_HakoCmdCamera(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: HakoCmdCamera, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: header 
