...
def pdu_to_py_HakoDroneCmdTakeoff(binary_data: bytes) -> HakoDroneCmdTakeoff:
...
def binary_read_recursive_HakoDroneCmdTakeoff(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: HakoDroneCmdTakeoff, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: header 
