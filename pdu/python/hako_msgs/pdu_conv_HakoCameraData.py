...
def pdu_to_py_HakoCameraData(pdu_bytes: bytes) -> HakoCameraData:
    ...
    nested_base_data = base_data[4:276]
...
def py_to_pdu_HakoCameraData(py_obj: HakoCameraData) -> bytes:
    ...
    base_buffer[4:276] = nested_base_data
    if nested_heap_data:
