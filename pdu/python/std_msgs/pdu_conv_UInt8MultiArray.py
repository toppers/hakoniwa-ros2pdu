...
def pdu_to_py_UInt8MultiArray(binary_data: bytes) -> UInt8MultiArray:
...
def binary_read_recursive_UInt8MultiArray(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: UInt8MultiArray, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
