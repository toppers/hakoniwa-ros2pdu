...
def pdu_to_py_Float32MultiArray(binary_data: bytes) -> Float32MultiArray:
...
def binary_read_recursive_Float32MultiArray(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: Float32MultiArray, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
