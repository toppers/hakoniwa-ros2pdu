...
def pdu_to_py_UInt16MultiArray(binary_data: bytes) -> UInt16MultiArray:
...
def binary_read_recursive_UInt16MultiArray(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: UInt16MultiArray, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
