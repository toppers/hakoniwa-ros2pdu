...
def pdu_to_py_UInt32MultiArray(pdu_bytes: bytes) -> UInt32MultiArray:
    ...
    for i in range(array_len):
        ...
        val = struct.unpack_from('<I', heap_data, current_heap_offset)[0]
...
def py_to_pdu_UInt32MultiArray(py_obj: UInt32MultiArray) -> bytes:
    ...
    for element in py_obj.data:
        elements_heap_bytes += struct.pack('<I', element)
