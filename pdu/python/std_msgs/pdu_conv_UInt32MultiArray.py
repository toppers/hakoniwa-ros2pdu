...
def pdu_to_py_UInt32MultiArray(binary_data: bytes) -> UInt32MultiArray:
...
def binary_read_recursive_UInt32MultiArray(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: UInt32MultiArray, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
