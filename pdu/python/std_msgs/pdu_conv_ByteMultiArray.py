...
def pdu_to_py_ByteMultiArray(binary_data: bytes) -> ByteMultiArray:
...
def binary_read_recursive_ByteMultiArray(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: ByteMultiArray, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
