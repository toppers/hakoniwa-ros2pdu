...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_MultiArrayDimension <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_MultiArrayDimension(binary_data)
        ...
        py_obj = MultiArrayDimension.from_json(json_str)
        
        binary_data = py_to_pdu_MultiArrayDimension(py_obj)
