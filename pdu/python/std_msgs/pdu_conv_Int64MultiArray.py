...
def pdu_to_py_Int64MultiArray(binary_data: bytearray) -> Int64MultiArray:
...
def binary_read_recursive_Int64MultiArray(meta: binary_io.PduMetaData, binary_data: bytearray, py_obj: Int64MultiArray, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
...
def py_to_pduInt64MultiArray(py_obj: Int64MultiArray) -> bytearray:
    binary_data = bytearray()
    base_allocator = DynamicAllocator(False)
    bw_container = BinaryWriterContainer(binary_io.PduMetaData())
    binary_write_recursive_Int64MultiArray(0, bw_container, base_allocator, py_obj)
...
def binary_write_recursive_Int64MultiArray(parent_off: int, bw_container: BinaryWriterContainer, allocator, py_obj: Int64MultiArray):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
    # type_name: MultiArrayLayout 
