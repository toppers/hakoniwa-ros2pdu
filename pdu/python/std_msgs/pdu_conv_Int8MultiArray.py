...
def pdu_to_py_Int8MultiArray(binary_data: bytes) -> Int8MultiArray:
...
def binary_read_recursive_Int8MultiArray(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: Int8MultiArray, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
