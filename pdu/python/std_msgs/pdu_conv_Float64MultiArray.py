...
def pdu_to_py_Float64MultiArray(binary_data: bytearray) -> Float64MultiArray:
    ...
    binary_read_recursive_Float64MultiArray(meta, binary_data, py_obj, binary_io.PduMetaData.PDU_META_DATA_SIZE)
    return py_obj
...
def py_to_pdu_Float64MultiArray(py_obj: Float64MultiArray) -> bytearray:
...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_Float64MultiArray <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_Float64MultiArray(binary_data)
        ...
        py_obj = Float64MultiArray.from_json(json_str)
        
        binary_data = py_to_pdu_Float64MultiArray(py_obj)
