...
def pdu_to_py_UInt64MultiArray(binary_data: bytes) -> UInt64MultiArray:
...
def binary_read_recursive_UInt64MultiArray(meta: binary_io.PduMetaData, binary_data: bytes, py_obj: UInt64MultiArray, base_off: int):
    # array_type: single 
    # data_type: struct 
    # member_name: layout 
