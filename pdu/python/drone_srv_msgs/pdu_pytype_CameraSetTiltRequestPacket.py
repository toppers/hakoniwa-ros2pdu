...
from ..drone_srv_msgs.pdu_pytype_CameraSetTiltRequest import CameraSetTiltRequest
...
class CameraSetTiltRequestPacket:
    """
    ROS message: drone_srv_msgs/CameraSetTiltRequestPacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceRequestHeader
    body: CameraSetTiltRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = CameraSetTiltRequest()

    def __str__(self):
        return f"CameraSetTiltRequestPacket(" + ", ".join([
