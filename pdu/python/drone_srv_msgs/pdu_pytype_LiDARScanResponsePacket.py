...
from ..drone_srv_msgs.pdu_pytype_LiDARScanResponse import LiDARScanResponse
...
class LiDARScanResponsePacket:
    ...
    body: LiDARScanResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = LiDARScanResponse()

    def __str__(self):
        return f"LiDARScanResponsePacket(" + ", ".join([
