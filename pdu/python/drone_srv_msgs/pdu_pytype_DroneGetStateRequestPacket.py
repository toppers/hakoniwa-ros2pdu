...
from ..drone_srv_msgs.pdu_pytype_DroneGetStateRequest import DroneGetStateRequest
...
class DroneGetStateRequestPacket:
    """
    ROS message: drone_srv_msgs/DroneGetStateRequestPacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceRequestHeader
    body: DroneGetStateRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = DroneGetStateRequest()

    def __str__(self):
        return f"DroneGetStateRequestPacket(" + ", ".join([
