...
from ..drone_srv_msgs.pdu_pytype_DroneGoToRequest import DroneGoToRequest
...
class DroneGoToRequestPacket:
    """
    ROS message: drone_srv_msgs/DroneGoToRequestPacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceRequestHeader
    body: DroneGoToRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = DroneGoToRequest()

    def __str__(self):
        return f"DroneGoToRequestPacket(" + ", ".join([
