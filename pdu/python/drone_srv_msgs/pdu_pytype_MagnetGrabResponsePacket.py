...
from ..drone_srv_msgs.pdu_pytype_MagnetGrabResponse import MagnetGrabResponse
...
class MagnetGrabResponsePacket:
    ...
    body: MagnetGrabResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = MagnetGrabResponse()

    def __str__(self):
        return f"MagnetGrabResponsePacket(" + ", ".join([
