...
from ..drone_srv_msgs.pdu_pytype_CameraCaptureImageRequest import CameraCaptureImageRequest
...
class CameraCaptureImageRequestPacket:
    """
    ROS message: drone_srv_msgs/CameraCaptureImageRequestPacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceRequestHeader
    body: CameraCaptureImageRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = CameraCaptureImageRequest()

    def __str__(self):
        return f"CameraCaptureImageRequestPacket(" + ", ".join([
