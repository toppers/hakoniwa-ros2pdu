...
from ..drone_srv_msgs.pdu_pytype_DroneLandResponse import DroneLandResponse
...
class DroneLandResponsePacket:
    """
    ROS message: drone_srv_msgs/DroneLandResponsePacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceResponseHeader
    body: DroneLandResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = DroneLandResponse()

    def __str__(self):
        return f"DroneLandResponsePacket(" + ", ".join([
