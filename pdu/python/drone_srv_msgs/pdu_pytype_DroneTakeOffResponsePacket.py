...
from ..drone_srv_msgs.pdu_pytype_DroneTakeOffResponse import DroneTakeOffResponse
...
class DroneTakeOffResponsePacket:
    """
    ROS message: drone_srv_msgs/DroneTakeOffResponsePacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceResponseHeader
    body: DroneTakeOffResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = DroneTakeOffResponse()

    def __str__(self):
        return f"DroneTakeOffResponsePacket(" + ", ".join([
