...
from ..drone_srv_msgs.pdu_pytype_DroneSetReadyRequest import DroneSetReadyRequest
...
class DroneSetReadyRequestPacket:
    """
    ROS message: drone_srv_msgs/DroneSetReadyRequestPacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceRequestHeader
    body: DroneSetReadyRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = DroneSetReadyRequest()

    def __str__(self):
        return f"DroneSetReadyRequestPacket(" + ", ".join([
