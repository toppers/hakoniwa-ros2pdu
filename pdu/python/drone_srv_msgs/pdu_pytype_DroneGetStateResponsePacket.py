...
from ..drone_srv_msgs.pdu_pytype_DroneGetStateResponse import DroneGetStateResponse
...
class DroneGetStateResponsePacket:
    ...
    body: DroneGetStateResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = DroneGetStateResponse()

    def __str__(self):
        return f"DroneGetStateResponsePacket(" + ", ".join([
