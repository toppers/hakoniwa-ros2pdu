...
from ..drone_srv_msgs.pdu_pytype_DroneTakeOffRequest import DroneTakeOffRequest
...
class DroneTakeOffRequestPacket:
    ...
    body: DroneTakeOffRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = DroneTakeOffRequest()

    def __str__(self):
        return f"DroneTakeOffRequestPacket(" + ", ".join([
