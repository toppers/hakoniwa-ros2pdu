...
from ..drone_srv_msgs.pdu_pytype_DroneGoToResponse import DroneGoToResponse
...
class DroneGoToResponsePacket:
    ...
    body: DroneGoToResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = DroneGoToResponse()

    def __str__(self):
        return f"DroneGoToResponsePacket(" + ", ".join([
