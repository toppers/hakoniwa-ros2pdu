...
from ..drone_srv_msgs.pdu_pytype_DroneLandRequest import DroneLandRequest
...
class DroneLandRequestPacket:
    ...
    body: DroneLandRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = DroneLandRequest()

    def __str__(self):
        return f"DroneLandRequestPacket(" + ", ".join([
