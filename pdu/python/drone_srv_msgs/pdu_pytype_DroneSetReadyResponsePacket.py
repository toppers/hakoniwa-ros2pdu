...
from ..drone_srv_msgs.pdu_pytype_DroneSetReadyResponse import DroneSetReadyResponse
...
class DroneSetReadyResponsePacket:
    ...
    body: DroneSetReadyResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = DroneSetReadyResponse()

    def __str__(self):
        return f"DroneSetReadyResponsePacket(" + ", ".join([
