...
from ..drone_srv_msgs.pdu_pytype_CameraSetTiltResponse import CameraSetTiltResponse
...
class CameraSetTiltResponsePacket:
    ...
    header: ServiceResponseHeader
    body: CameraSetTiltResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = CameraSetTiltResponse()

    def __str__(self):
        return f"CameraSetTiltResponsePacket(" + ", ".join([
