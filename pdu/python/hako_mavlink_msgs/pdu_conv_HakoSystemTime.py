...
def py_to_pdu_HakoSystemTime(py_obj: HakoSystemTime) -> bytearray:
...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_HakoSystemTime <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_HakoSystemTime(binary_data)
        ...
        py_obj = HakoSystemTime.from_json(json_str)
        
        binary_data = py_to_pdu_HakoSystemTime(py_obj)
