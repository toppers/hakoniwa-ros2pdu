...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_CompressedImage <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_CompressedImage(binary_data)
        ...
        py_obj = CompressedImage.from_json(json_str)
        
        binary_data = py_to_pdu_CompressedImage(py_obj)
