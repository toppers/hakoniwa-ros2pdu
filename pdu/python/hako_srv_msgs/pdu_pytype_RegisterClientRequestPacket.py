...
from ..hako_srv_msgs.pdu_pytype_RegisterClientRequest import RegisterClientRequest
...
class RegisterClientRequestPacket:
    """
    ROS message: hako_srv_msgs/RegisterClientRequestPacket
    ...
    def __init__(self):
        ...
        self.body = RegisterClientRequest()

    def __str__(self):
        return f"RegisterClientRequestPacket(" + ", ".join([
