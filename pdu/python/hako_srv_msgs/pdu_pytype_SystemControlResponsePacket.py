...
from ..hako_srv_msgs.pdu_pytype_SystemControlResponse import SystemControlResponse


# class definition for the ROS message
class SystemControlResponsePacket:
    """
    ROS message: hako_srv_msgs/SystemControlResponsePacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceResponseHeader
    body: SystemControlResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = SystemControlResponse()

    def __str__(self):
        return f"SystemControlResponsePacket(" + ", ".join([
