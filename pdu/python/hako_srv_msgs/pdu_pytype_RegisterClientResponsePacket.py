...
from ..hako_srv_msgs.pdu_pytype_RegisterClientResponse import RegisterClientResponse
...
class RegisterClientResponsePacket:
    """
    ROS message: hako_srv_msgs/RegisterClientResponsePacket
    ...
    def __init__(self):
        ...
        self.body = RegisterClientResponse()

    def __str__(self):
        return f"RegisterClientResponsePacket(" + ", ".join([
