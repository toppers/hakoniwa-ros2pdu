...
from ..hako_srv_msgs.pdu_pytype_SystemControlRequest import SystemControlRequest


# class definition for the ROS message
class SystemControlRequestPacket:
    """
    ROS message: hako_srv_msgs/SystemControlRequestPacket
    Generated by hakoniwa-ros2pdu.
    """

    header: ServiceRequestHeader
    body: SystemControlRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = SystemControlRequest()

    def __str__(self):
        return f"SystemControlRequestPacket(" + ", ".join([
