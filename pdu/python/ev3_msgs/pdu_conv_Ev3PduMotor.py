...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_Ev3PduMotor <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_Ev3PduMotor(binary_data)
        ...
        py_obj = Ev3PduMotor.from_json(json_str)
        
        binary_data = py_to_pdu_Ev3PduMotor(py_obj)
