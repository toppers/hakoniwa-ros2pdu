...
def pdu_to_py_Ev3PduActuatorHeader(binary_data: bytearray) -> Ev3PduActuatorHeader:
...
def binary_read_recursive_Ev3PduActuatorHeader(meta: binary_io.PduMetaData, binary_data: bytearray, py_obj: Ev3PduActuatorHeader, base_off: int):
    # array_type: single 
    # data_type: primitive 
    # member_name: name 
    # type_name: string 
    ...
    py_obj.asset_time = binary_io.binTovalue("int64", bin)
...
def py_to_pdu_Ev3PduActuatorHeader(py_obj: Ev3PduActuatorHeader) -> bytearray:
    ...
    binary_write_recursive_Ev3PduActuatorHeader(0, bw_container, base_allocator, py_obj)
...
def binary_write_recursive_Ev3PduActuatorHeader(parent_off: int, bw_container: BinaryWriterContainer, allocator, py_obj: Ev3PduActuatorHeader):
    # array_type: single 
    # data_type: primitive 
    # member_name: name 
    # type_name: string 
    ...
    bin = binary_io.typeTobin(type, py_obj.asset_time)
...
if __name__ == "__main__":
    ...
    def print_usage():
        print(f"Usage: python -m pdu.python.pdu_conv_Ev3PduActuatorHeader <read|write> [args...]")
    ...
    if command == "read":
        ...
        py_obj = pdu_to_py_Ev3PduActuatorHeader(binary_data)
        ...
        py_obj = Ev3PduActuatorHeader.from_json(json_str)
        
        binary_data = py_to_pdu_Ev3PduActuatorHeader(py_obj)
